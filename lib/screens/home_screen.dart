...
import 'package:fluuter_boilerplate/screens/learn_riverpod/riverpod_learn_screen.dart';
          ...
          children: [
            ...
            Card(
              child: ListTile(
                ...
                title: const Text(AppTexts.riverpod),
                onTap: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => const RiverpodMathScreen(),
                    ),
                  );
                },
              ),
